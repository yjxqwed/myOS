...
// |--------|-|-|-|-|---- |-|--|-|----|--------|--------|--------|--------|--------|  占位
// |  BASE  |G|S|0|0|LIMIT|P|D |S|TYPE|<------- BASE 23-0 ------>|<-- LIMIT 15-0 ->|  含义
// |  31-24 |R|Z| | |19-16|R|P | |    |
//          | | | | |     | |L | |    |

// Segment Descriptor Layout for TSS (64 bits)
// |   7    |     6       |     5      |   4    |   3    |   2    |   1    |   0    |  字节
// |76543210|7 6 5 4 3210 |7 65 432 1 0|76543210|76543210|76543210|76543210|76543210|  比特
// |--------|-|-|-|-|---- |-|--|---|-|-|--------|--------|--------|--------|--------|  占位
// |  BASE  |G|S|0|0|LIMIT|P|D |010|B|1|<------- BASE 23-0 ------>|<-- LIMIT 15-0 ->|  含义
// |  31-24 |R|Z| | |19-16|R|P |   | | |
//          | | | | |     | |L |   | | |
//
// B: busy bit
